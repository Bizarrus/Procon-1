namespace PRoCon.Forms {
    partial class frmOptions {
        ...
        private void InitializeComponent() {
			...
			this.chkEnableUnicode = new System.Windows.Forms.CheckBox();
    ...
    "have";
			...
			// tabAdv2
			// 
			this.tabAdv2.Controls.Add(this.label2);
			this.tabAdv2.Controls.Add(this.chkEnableUnicode);
			this.tabAdv2.Controls.Add(this.label1);
			...
			this.label2.Text = "Only activate if you know what you are doing and what effect those settings will " +
    "have\r\n\r\nWARNING: If you using ProCon-Layer, this settings must be enabled on bot" +
    "h sites!";
			// 
			// chkEnableUnicode
			// 
			this.chkEnableUnicode.AutoSize = true;
			this.chkEnableUnicode.Checked = true;
			this.chkEnableUnicode.CheckState = System.Windows.Forms.CheckState.Checked;
			this.chkEnableUnicode.Location = new System.Drawing.Point(30, 82);
			this.chkEnableUnicode.Name = "chkEnableUnicode";
			this.chkEnableUnicode.Size = new System.Drawing.Size(197, 19);
			this.chkEnableUnicode.TabIndex = 21;
			this.chkEnableUnicode.Text = "Enable UTF-8 for the connection";
			this.chkEnableUnicode.UseVisualStyleBackColor = true;
			this.chkEnableUnicode.CheckedChanged += new System.EventHandler(this.checkBox1_CheckedChanged);
			// 
			// label1
			// 
			...
			this.panel20.Location = new System.Drawing.Point(20, 72);
		...
		private System.Windows.Forms.CheckBox chkEnableUnicode;
